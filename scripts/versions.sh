...
# This script extracts the Elixir and Erlang versions from the .tool-versions file
# and sets them as environment variables for use in a GitHub Actions workflow.
