defmodule WedidWeb.Router do
  ...
  scope "/", WedidWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {WedidWeb.LiveUserAuth, :live_user_optional}
      #
    ...
    sign_in_route register_path: "/register",
                  ...
                  on_mount: [{WedidWeb.LiveUserAuth, :live_no_user}],
                  overrides: [WedidWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    ...
    confirm_route Wedid.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [WedidWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Wedid.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [WedidWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    )
  end
  ...
  # scope "/api", WedidWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:wedid, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: WedidWeb.Telemetry
